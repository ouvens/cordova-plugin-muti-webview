...
public class WebViewPlugin2 extends CordovaPlugin {

  private static final String LOG_TAG = "WebViewPlugin2";
  public static WebViewPlugin2 webViewPlugin = null;
  public static WebViewActivity2 webViewActivity = null;
  ...
  */
  ...
  private void showWebView(final String url, final String errorUrl, Boolean shouldShowLoading) {
    ...
    Intent i = new Intent(this.cordova.getActivity(), WebViewActivity2.class);
    i.putExtra("url", url);
  ...
  private void hideWebView() {
    ...
    WebViewPlugin2.webViewActivity.finish();
