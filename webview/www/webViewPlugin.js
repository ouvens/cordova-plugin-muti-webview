...
module.exports = (function() {
  var _show = function(url, successCallback, errorCallback, loading, errorUrl) {
    if(loading) {
        cordova.exec(successCallback, errorCallback, 'WebViewPlugin', 'show', [url, errorUrl, loading]);
    }
    else {
        cordova.exec(successCallback, errorCallback, 'WebViewPlugin', 'show', [url, errorUrl]);
    }
  };
