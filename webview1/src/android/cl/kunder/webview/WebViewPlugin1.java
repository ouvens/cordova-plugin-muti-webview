...
public class WebViewPlugin1 extends CordovaPlugin {

  private static final String LOG_TAG = "WebViewPlugin1";
  public static WebViewPlugin1 webViewPlugin = null;
  public static WebViewActivity1 webViewActivity = null;
  ...
  */
  public boolean execute(String action, JSONArray args, CallbackContext callbackContext) throws JSONException {
    if (action.equals("show") && args.length() > 0) {
      ...
      final String errorUrl = args.getString(1);
      Boolean shouldShowLoading = false;
      try{
        shouldShowLoading = args.getBoolean(2);
      }
      catch(Exception e){
      }
      if(!"".equals(url)) {
        showWebView(url, errorUrl, shouldShowLoading);
  ...
  private void showWebView(final String url,final String errorUrl, Boolean shouldShowLoading) {
    LOG.d(LOG_TAG, "Url: " + url);
    Intent i = new Intent(this.cordova.getActivity(), WebViewActivity1.class);
    i.putExtra("url", url);
    i.putExtra("errorUrl", errorUrl);
  ...
  private void hideWebView() {
    ...
    WebViewPlugin1.webViewActivity.finish();
